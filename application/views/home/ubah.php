                ...
                <div class="col-lg">
                    <div class="p-5">
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4">Ubah Akun Baru</h1>
                        </div>
                        ...
                        <form action="" method="post" style="color: black; ">
                            ...
                            <div class="form-group">
                                <input type="text" name="nama" class="form-control form-control-user" id="nama"
                                    ...
                                    value="<?php echo set_value('nama'); ?><?php echo $pengguna['nama']; ?>">
                            ...
                            <div class="form-group">
                                <input type="text" name="username" class="form-control form-control-user" id="username"
                                    ...
                                    value="<?php echo set_value('username'); ?> <?php echo $pengguna['username']; ?>">
